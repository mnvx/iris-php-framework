...
<head>
  ...
  <link rel="stylesheet" href="<?php echo $Config::$base_url; ?>/theme/<?php echo basename(__DIR__); ?>/css/main-d.css" type="text/css" media="screen" />
...
<body>
  <div id="wrap">
    <div class="navbar navbar-inverse navbar-fixed-top">
      <div class="navbar-inner">
        <div class="container">
          <a class="brand" href="<?php echo $Router->url('home'); ?>"><?php echo _($Config::$app_name); ?></a>
          <div class="nav-collapse collapse">
            <?php include $this->get_view_file_name(CoreModule::singleton()->get_class_path_name('OptionsConfig'), 'params'); ?>
            <ul class="nav">
  ...
  <?php 
    // Debug info
    $debug_view_filename = $this->get_view_file_name(null, 'debug');
    if ($debug_view_filename) {
      include $debug_view_filename;
    }
  ?>
