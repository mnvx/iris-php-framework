...
<body>
  <div id="wrap">
    <div class="navbar navbar-inverse navbar-fixed-top">
      <div class="navbar-inner">
        <div class="container">
          <a class="brand" href="<?php echo $router->_url(); ?>"><?php echo _(Config::$app_name); ?></a>
          <div class="nav-collapse collapse">
            <?php include $template->get_view_file_name('params'); ?>
            <ul class="nav">
              ...
              <?php } else { ?>
                ...
                <?php echo _('or'); ?>
                <a href="<?php echo $router->_url(); ?>/signup" class="navbar-link"><?php echo _('Signup'); ?></a>
              <?php } ?>
              </p></li>
            </ul>
            <?php if (Config::$debug) { ?>
    ...
    <div class="container" id="main">
      <?php if (!($template->get_controller_name() == 'site' && $template->get_action_name() == 'home')) { ?>
      <div class="hero-unit">
  ...
  <?php include $template->get_view_file_name('debug'); ?>
